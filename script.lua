-- OTIMIZADOR DE FPS SUPREMO + VELOCIDADE (SEM ABAS / ATIVAÇÃO DIRETA)
...
-- Loop leve em segundo plano para garantir que a velocidade não resete durante o farm
task.spawn(function()
...
-- 2. DESTRÓI TEXTURAS E ELEMENTOS PESADOS
...
-- 3. DESATIVA ILUMINAÇÃO, SOMBRAS E FILTROS DE COR
if Lighting then
...
-- 4. REMOVE DETALHES E MOVIMENTOS DA ÁGUA
if Terrain then
...
-- 5. LIMPEZA DE DETRITOS NO CHÃO
if Workspace:FindFirstChild("Debris") then
    Workspace.Debris:ClearAllChildren()
end

print("[Sucesso] Otimização Suprema e Velocidade Ativadas!")
